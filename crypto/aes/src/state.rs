...
//          We can probably get rid of most or all of the unit tests below since they will be
...
/// ```
///
/// This implementation evaluates both arms unconditionally and select between them with a mask, so that the timing
